...
bg_images = []
for i in range(1, 6):
    bg_image = pygame.image.load(f"assets/bg_images/{i}.png").convert_alpha()
...
def display_timer(screen, start_time):
    ...
    timer_text = timer_font.render(f"Time: {elapsed_time} seconds", True, (255, 255, 255))
    text_rect = timer_text.get_rect()
    text_rect.topright = (1066 - 20, 20)  # Position the timer at the top-right corner of the screen
